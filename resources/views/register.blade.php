...
<body style="background-color: gray;">
	<section class="w3l-form-36"><center>
			...
			<div class="wrapper">
				<div class="form-inner-cont">
					...
					<div class="social-icons">
						...
						<p class="signup"> <a href="/registerDriver" style="color:white">Devenir chauffeur</a> </p>
					</div>
				...
				@endif	
					...
					<p class="signup">Vous êtes déjà un membre ? <a href="/login" class="signuplink" style="color:white">Se connecter</a></p>
				</div>

				<!-- copyright -->
				<div class="copy-right">
					<p>© 2023 <a href="/welcome" style="color:white">Taxibokko-App</a>. All rights reserved | Design by Fray Kevin</p>
				</div>
				<!-- //copyright -->
			</div>
		</div></center>
